...
/**
 * Class mainly for wrapping ConsoleCommandSender to not log messages into console and instead store it internally
 * 
 * @author Flourick
 */
public class SilentOutputSender implements CommandSender
{
